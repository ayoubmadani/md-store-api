...
export class UpdateWalletAndUUID1776958474400 implements MigrationInterface {
    name = 'UpdateWalletAndUUID1776958474400'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "stores" ADD "themeId" uuid`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "stores" DROP COLUMN "themeId"`);
    }
